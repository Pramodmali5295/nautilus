                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="mt-14 pt-10 border-t border-navy/10">
                                                <div className="flex items-center gap-6 text-navy/60 text-base md:text-lg italic">
                                                    <div className="w-12 h-12 rounded-full bg-navy/5 flex items-center justify-center shadow-inner border border-navy/10">
